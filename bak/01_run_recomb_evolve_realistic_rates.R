...
simulation_script <- "slim_sim/recomb_rate_evolve_realistic.txt"
out_folder_base <- "data/slim_output/"

# run the actual simulation
mclapply_wrapper(replicates, model_params, "slim_sim/recomb_rate_evolve_realistic.txt", out_folder_base, cores)
